...
export default function SigninForm() {
    ...
    return (
        <Form form={form} name="basic" onFinish={onFinish} autoComplete="off" className="auth-form">
            <Form.Item
                name="email"
                rules={[validationRules.REQUIRED('Please write your email'), validationRules.EMAIL()]}
            >
            ...
            <Form.Item
                name="password"
                rules={[validationRules.REQUIRED('Please write your password'), validationRules.PASSWORD()]}
            >
